...
<div class="content">
    ...
    <!-- INFORMATION 0 -->
                    <div class="info_0">
                        <div class="image_actu" id="div_actu_0">
    ...
    <!-- INFORMATION 1 -->
                    <div class="info_1">
                        <div class="image_actu" id="div_actu_1">
    ...
    <!-- INFORMATION 2 -->
                    <div class="info_2">
                        <div class="image_actu" id="div_actu_2">
    ...
    <!-- INFORMATION 3 -->
                <div class="info_3">
                    <div class="image_actu" id="div_actu_3">
                ...
                <hr class="actu_port">
    <!-- INFORMATION 4 -->
                <div class="info_4" id="div_actu_4">
    ...
    <!-- INFORMATION 5 -->
                <div class="info_5">
                    <div class="image_actu" id="div_actu_5">
    ...
    <!-- INFORMATION 6 -->
                <div class="info_6">
                    <div class="image_actu" id="div_actu_6">
    ...
    <!-- INFORMATION 7 -->
                <div class="info_7">
                    <div class="image_actu" id="div_actu_7">
...
<!-- --------------------------------------------------------------------------------------------------------- -->
    <div class="short">
        <div class="titre_musique"><p style="padding-left: 15px;font-size: 26px;">Email</p></div>
        <div class="email_template">
                <?php
                        echo nl2br(date("\n"."Heure :"."d-m, H:i", strtotime($date_1)));
                        if (!empty($sujet_1)){
                            echo nl2br("\n".$sujet_1);
                        } else {
                            echo nl2br("\n"."Aucun objet");
                        ...
                        echo nl2br(date("\n"."Heure :"."d-m, H:i", strtotime($date_2)));
                        if (!empty($sujet_2)){
                            echo nl2br("\n".$sujet_2);
                        } else {
                            echo nl2br("\n"."Aucun objet");
                        ...
                        echo nl2br(date("\n"."Heure :"."d-m, H:i", strtotime($date_3)));
                        if (!empty($sujet_3)){
                            echo nl2br("\n".$sujet_3);
                        } else {
                            echo nl2br("\n"."Aucun objet");
